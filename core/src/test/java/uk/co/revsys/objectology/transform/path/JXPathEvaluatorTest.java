...
public class JXPathEvaluatorTest {

    public JXPathEvaluatorTest() {
    }
    ...
    /**
     * Test of evaluate method, of class JXPathEvaluator.
     */
    @Test
    public void testEvaluate() throws Exception {
       IMocksControl mocksControl = EasyMock.createControl();
        ...
        PathEvaluator pathEvaluator = new JXPathEvaluator();
        ...
        assertEquals("abcd:1234", pathEvaluator.evaluate(instance, "concat(/template/id, ':', /id)"));
        assertEquals(new Property("value1"), pathEvaluator.evaluate(instance, "/attributes/dictionary/map[@name='key1']"));
        assertNull(null, pathEvaluator.evaluate(instance, "/blahblah"));
        mocksControl.verify();
    }
