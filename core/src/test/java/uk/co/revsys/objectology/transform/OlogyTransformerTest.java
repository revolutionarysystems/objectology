...
public class OlogyTransformerTest {
    ...
    public void testTransform() throws Exception {
        ...
        template.setAttributeTemplate("limit1", new MeasurementTemplate());
        template.setAttributeTemplate("limit2", new MeasurementTemplate());
        ...
        instance.setAttribute("limit1", new Measurement(1));
        instance.setAttribute("limit2", new Measurement(2));
        ...
        rootRuleSet1.addRule(new OneToOneMappingRule("description", "concat(/template/type, ':' ,/name)"));
