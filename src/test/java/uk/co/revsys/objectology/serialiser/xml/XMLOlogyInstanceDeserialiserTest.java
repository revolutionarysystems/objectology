...
public class XMLOlogyInstanceDeserialiserTest {
	...
	public void testDeserialise() throws Exception {
		...
		assertEquals("01/01/2001 00:00:00", instance.getAttribute("startTime", Time.class).getValue());
		assertEquals("1000", instance.getAttribute("limit", Measurement.class).getValue());
